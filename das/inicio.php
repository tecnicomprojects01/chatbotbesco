...
<body class="animsition">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Estadisticas <?php echo $hoy1;  ?></h2>
                                ...
                                <div class="overview-item overview-item--c1">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            $sql1 = "SELECT * FROM llamado_vendedor where created_at   like '$hoy%' and tipo_llamado_id=3";
                                            $result1 = mysqli_query($db,$sql1);
                                            $row1 = mysqli_fetch_array($result1,MYSQLI_ASSOC);                              
                                            $count1 = mysqli_num_rows($result1);

                                            $sql2 = "SELECT * FROM llamado_vendedor where created_at   like '$hoy%' and tipo_llamado_id=2";
                                            $result2 = mysqli_query($db,$sql2);
                                            $row2 = mysqli_fetch_array($result2,MYSQLI_ASSOC);                                            
                                            $count2 = mysqli_num_rows($result2);

                                            $sql3 = "SELECT * FROM llamado_vendedor where created_at   like '$hoy%' and tipo_llamado_id=1";
                                            ...
                                            $llamadas=round((($count3/$total)*100),2);
                                            $wapp=round((($count2/$total)*100),2);
                                            $contacto=round((($count1/$total)*100),2);



                                            ?>
                                                <h2><?php echo $total; ?></h2>
                                                <span>TOTAL CONVERSIONES</span>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="au-card chart-percent-card">
                                    <div class="au-card-inner">
                                        <h3 class="title-2 tm-b-5">CONVERSIONES EN %</h3>
    ...
    var d2 = '<?php echo $llamadas ?>';
    var d1 = '<?php echo $contacto ?>';
    var d3 = '<?php echo $wapp ?>';
