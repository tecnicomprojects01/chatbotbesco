    ...
    <script type="text/javascript">
        ...
        $( document ).ready(function() {
        	...
        	$('.enviar_llamada_c').on('click',function(){
         	...
         	//Mostrar chat
         	setTimeout("mostrar_chat()",2000);
         	setTimeout("bajar_scroll()",3000);
	...
	<div class="container-fluid h-100">
		<div class="row justify-content-center h-100 back_chat">
			...
			<div class="col-md-6 col-xl-6 chat">
				<a  class="btn btn-primary" href="<?= base_url('index.php/chat/borrar_session')?>" title="Boton de prueba para eliminar sesión" style="margin-bottom: 10px;color:white">Borrar session</a>
				<div class="card">
					<div class="card-header msg_head">
						...
						<a id="call_c" href="javascript:;" title="¡Llámanos Gratis!"><span style="font-size: 13px;">¡Llámanos Gratis!</span> <i class="fas fa-phone" style="font-size: 20px;"></i></a>
						<span id="minimize_c"><i class="fas fa-window-minimize"></i></span>
						<span id="action_menu_btn"><i class="fas fa-ellipsis-v"></i></span>
						<div class="action_menu">
							<ul>
								<li><i class="fas fa-phone"></i> ¡Llámanos Gratis!</li>
					...
					<div class="card-footer">
						<div style="padding: 8px;width: 100%;background: transparent;text-align: center;color: white;position: absolute;bottom: 77px;display: none" id="escribiendo"><?= BOT_NAME?> está escribiendo...</div>
						<div class="input-group">
							
							<input type="text" class="form-control type_msg"  id="type_msg" placeholder="Escriba su mensaje..." onkeypress="if(event.keyCode == 13) send_msg()" style="border-radius: 10px 0 0 10px;"> 
...
<div id="contacto_c_modal" class="modal fade" data-backdrop="true">
      ...
      <div class="modal-body text-center p-lg datos_c_body">
      	...
      	<?php if(!isset($cliente['datos_contacto']) OR $cliente['datos_contacto'] == 0): ?>
      		...
      		<div class="form-group">
      			<input class="form-control" id="dni_chat" placeholder="Ingresa tu DNI" maxlength="50" onkeypress="return valida(event)" >
      		</div>
